...
In the construction of a broadband network, a **node** serves as a local hub for community network traffic which every building and home can connect to, which then connects these
users to their community's point of presense (POP). 
